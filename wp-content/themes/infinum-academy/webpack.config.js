...
module.exports = (env, argv) => {
	...
	const projectConfig = {
		config: {
			...
			projectUrl: 'infinum-academy.test', // Used for providing browsersync functionality.
			projectPath: 'wp-content/themes/infinum-academy', // Project path relative to project root.
		},
	};
